...
from Registration_profile.views import RegesterationView, Validation
...
urlpatterns = [
    ...
    path('backend/api/auth/registration/', RegesterationView.as_view()),
    path('backend/api/auth/registration/validation/', Validation.as_view()),
